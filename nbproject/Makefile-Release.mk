...
${OBJECTDIR}/src/Pila_max_VD.o: src/Pila_max_VD.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Pila_max_VD.o src/Pila_max_VD.cpp

${OBJECTDIR}/src/usopilas_max.o: src/usopilas_max.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/usopilas_max.o src/usopilas_max.cpp
